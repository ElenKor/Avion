...
b{
  ...
  <form class="form-container" action="" method="post">
    ...
    <label style="font-size: 20px; color: #D0D3D4;" for="username"><b>Имя пользователя</b></label>
    ...
    <br><br>
    <div class="signup">
   <a style="color: #D0D3D4; font-size: 15px;text-decoration: none" href="demo2.html">Зарегистрироваться</a><br>
      </div>
